...
with tf.Session().as_default():
    ...
    plt.title('Anomalies and Non Anomalies from Abdomen Scan')
    plt.ylabel('Abdomen_1')
    ...
    plt.title('Anomalies from Abdomen Scan')
    ...
    plt.xlim(df3['timestamp'].min(), df3['timestamp'].max())
    plt.ylim(-.00006, .00006)
    plt.title('Non Anomalies from Abdomen Scan')
