...
file_name = 'r10.edf'
save_dir ='/Users/shachatt1/PycharmProjects/IOTSimulation/featal-ecg-anomaly-detection/model_dir/brain/'
...
with tf.Session().as_default():
    ...
    plt.savefig('figs/out_anomaly_brain.png')
    ...
    plt.savefig('figs/out_brain_anomaly.png')
